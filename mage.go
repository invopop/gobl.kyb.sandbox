...
// Mage targets for gobl.kyb.sandbox. Run via `mage <target>`.
package main
...
// Build compiles the gobl.kyb.sandbox binary into ./bin.
func Build() error {
	return sh.RunV("go", "build", "-o", "./bin/gobl.kyb.sandbox", "./cmd/gobl.kyb.sandbox")
}
