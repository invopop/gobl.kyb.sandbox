...
var (
	...
	// ErrGone is returned when a confirmation link has expired: the
	// resource existed but is no longer usable, and the subject must
	// re-register to receive a fresh one.
	ErrGone = NewError("gone")
